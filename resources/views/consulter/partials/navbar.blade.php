            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="{{ asset('user/uploads/no-img-avatar.png')}}"alt="">
                        </div>
                        <div class="text-center">
                            <p class="tx-16 fw-bolder">{{$consulter->name}}</p>
                            <p class="tx-12 text-muted">{{$consulter->email}}</p>
                        </div>
                    </div>
